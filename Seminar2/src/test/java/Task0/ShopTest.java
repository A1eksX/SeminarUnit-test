...
//        Cart cart = new Cart(shop);
    ...
    void quantityProductsStoreChanging() {
        // Act
        for (int i = 0; i < 5; i++) {
            cart.addProductToCartByID(10); // 10 | rice      | 100.0    | 30
        }

        // Assert
        assertThat(shop.getProductsShop().get(9).getQuantity()).isEqualTo(25);
    }
    ...
    void lastProductsDisappearFromStore() {
        // Act
        for (int i = 0; i < 10; i++) {
            cart.addProductToCartByID(1); // 1  | bacon     | 170.0    | 10
        }
    ...
    void deletedProductIsReturnedToShop() {
        ...
        cart.removeProductByID(1);
        assertThat(cart.cartItems.get(0).getQuantity()).isEqualTo(8);
        assertThat(shop.getProductsShop().get(0).getQuantity()).isEqualTo(2);
    }
